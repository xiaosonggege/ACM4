...
void enqueue(Queue_p pq, BiTNode t){
...
int main(int argc, char *argv[]){
    ///////////////////////////////////函数初始化区域
    void visit(int e); //对二叉树结点操作的函数
    BiTree & InitBiTree(BiTree &T); //构造空二叉树
    void CreateBiTree(BiTree &T, char string[], int size); //根据要求次序输入二叉树中结点值
    void PreOrderTraverse(BiTree &T, void (*visit)(int e)); //先序遍历二叉树
    void InOrderTraverse(BiTree &T, void (*visit)(int e)); //中序遍历二叉树
    void InOrderTraverse_no_cur_no_stack(BiTree &T, void (*visit)(int e)); //中序非递归无堆栈遍历二叉树
    void PostOrderTraverse(BiTree &T, void (*visit)(int e)); //后序遍历二叉树
    void LevelOrderTraverse(BiTree &T, void (*visit)(int e)); //层序遍历二叉树
...
void InOrderTraverse(BiTree &T, void (*visit)(int e)){
    if (T){
...
void PostOrderTraverse(BiTree &T, void (*visit)(int e)){
    if (T){
...
void LevelOrderTraverse(BiTree &T, void (*visit)(int e)){
